...
const int todx[] = { -2, -2, -1, -1,  1,  1,  2,  2 ,0,0,3,-3};
const int tody[] = { -1,  1, -2,  2, -2,  2, -1,  1, 3,-3,0,0};
...
int main(){
    ...
    else if(abs(x-r)+abs(y-c)<=3){
        ans=1;
    }
    else if((abs(x-y)==abs(r-c))){
        ans=2;
    }
    else if((x-y+r+c)%2==0){
    	ans=2;
