...
int main(){
 ...
 cin>>s;
 ll cnt=0;
 list<char> kisuparina;
 for(auto x:s){
 	kisuparina.pb(x);
 }
 list <char> :: iterator itr; 
   /* for(it = kisuparina.begin(); itr != kisuparina.end()-2; ++it) {
    	if(*(itr)=='f' && *(itr+1)=='o' && *(itr+2)=='x'){
    		cnt++;
    		kisuparina.erase(itr,itr+2);
    		itr--;
    	}
    	if(kisuparina.empty()==true)break;
    }*/
    for(itr = kisuparina.begin(); itr != kisuparina.end(); ++itr) {
    	cout<<*itr<<" "<<*(itr.next());
